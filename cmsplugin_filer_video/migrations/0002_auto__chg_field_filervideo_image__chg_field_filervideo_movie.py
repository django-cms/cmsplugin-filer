...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FilerVideo.image'
        db.alter_column('cmsplugin_filervideo', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.SET_NULL, to=orm['filer.Image'], null=True))

        # Changing field 'FilerVideo.movie'
        db.alter_column('cmsplugin_filervideo', 'movie_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.File'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'FilerVideo.image'
        db.alter_column('cmsplugin_filervideo', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['filer.Image']))

        # Changing field 'FilerVideo.movie'
        db.alter_column('cmsplugin_filervideo', 'movie_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.File'], null=True))
    ...
    models = {
        ...
        'cmsplugin_filer_video.filervideo': {
            ...
            'image': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'filer_video_image'", 'on_delete': 'models.SET_NULL', 'default': 'None', 'to': "orm['filer.Image']", 'blank': 'True', 'null': 'True'}),
            ...
            'movie': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['filer.File']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),

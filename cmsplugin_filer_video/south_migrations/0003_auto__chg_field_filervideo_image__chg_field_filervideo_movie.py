...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'cmsplugin_filer_video_filervideo', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['filer.Image']))

        # Changing field 'FilerVideo.movie'
        db.alter_column(u'cmsplugin_filer_video_filervideo', 'movie_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.File'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'FilerVideo.image'
        db.alter_column(u'cmsplugin_filer_video_filervideo', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['filer.Image']))

        # Changing field 'FilerVideo.movie'
        db.alter_column(u'cmsplugin_filer_video_filervideo', 'movie_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.File'], null=True))
    ...
    models = {
        ...
        u'cmsplugin_filer_video.filervideo': {
            ...
            'image': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'filer_video_image'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['filer.Image']"}),
            ...
            'movie': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['filer.File']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),

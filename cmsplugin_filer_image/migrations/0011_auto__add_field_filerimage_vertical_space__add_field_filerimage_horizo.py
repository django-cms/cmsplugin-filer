...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FilerImage.vertical_space'
        db.add_column('cmsplugin_filerimage', 'vertical_space',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'FilerImage.horizontal_space'
        db.add_column('cmsplugin_filerimage', 'horizontal_space',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'FilerImage.border'
        db.add_column('cmsplugin_filerimage', 'border',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FilerImage.vertical_space'
        db.delete_column('cmsplugin_filerimage', 'vertical_space')

        # Deleting field 'FilerImage.horizontal_space'
        db.delete_column('cmsplugin_filerimage', 'horizontal_space')

        # Deleting field 'FilerImage.border'
        db.delete_column('cmsplugin_filerimage', 'border')
    ...
    models = {
        ...
        'cms.cmsplugin': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 4, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

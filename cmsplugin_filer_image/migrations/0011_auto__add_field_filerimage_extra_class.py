...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FilerImage.extra_class'
        db.add_column(u'cmsplugin_filerimage', 'extra_class',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FilerImage.extra_class'
        db.delete_column(u'cmsplugin_filerimage', 'extra_class')
    ...
    models = {
        ...
        u'cmsplugin_filer_image.filerimage': {
            'Meta': {'object_name': 'FilerImage', 'db_table': "u'cmsplugin_filerimage'", '_ormbases': ['cms.CMSPlugin']},
            ...
            'extra_class': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),

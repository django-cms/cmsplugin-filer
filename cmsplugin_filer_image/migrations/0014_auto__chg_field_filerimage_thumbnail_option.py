...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FilerImage.thumbnail_option'
        db.alter_column('cmsplugin_filerimage', 'thumbnail_option_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cmsplugin_filer_image.ThumbnailOption'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'FilerImage.thumbnail_option'
        db.alter_column('cmsplugin_filerimage', 'thumbnail_option_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cmsplugin_filer_image.ThumbnailOption'], null=True))

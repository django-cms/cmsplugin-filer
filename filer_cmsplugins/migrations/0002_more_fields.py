...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FilerTeaser.height'
        db.add_column('cmsplugin_filerteaser', 'height', orm['filer_cmsplugins.filerteaser:height'])
        
        # Adding field 'FilerTeaser.use_autoscale'
        db.add_column('cmsplugin_filerteaser', 'use_autoscale', orm['filer_cmsplugins.filerteaser:use_autoscale'])
        
        # Adding field 'FilerTeaser.width'
        db.add_column('cmsplugin_filerteaser', 'width', orm['filer_cmsplugins.filerteaser:width'])
        
        # Adding field 'FilerImage.use_autoscale'
        db.add_column('cmsplugin_filerimage', 'use_autoscale', orm['filer_cmsplugins.filerimage:use_autoscale'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'FilerTeaser.height'
        db.delete_column('cmsplugin_filerteaser', 'height')
        
        # Deleting field 'FilerTeaser.use_autoscale'
        db.delete_column('cmsplugin_filerteaser', 'use_autoscale')
        
        # Deleting field 'FilerTeaser.width'
        db.delete_column('cmsplugin_filerteaser', 'width')
        
        # Deleting field 'FilerImage.use_autoscale'
        db.delete_column('cmsplugin_filerimage', 'use_autoscale')

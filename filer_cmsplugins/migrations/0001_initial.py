...
from filer_cmsplugins.models import *
...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('cmsplugin_filerimage', (
            ('cmsplugin_ptr', orm['filer_cmsplugins.FilerImage:cmsplugin_ptr']),
            ('image', orm['filer_cmsplugins.FilerImage:image']),
            ('alt_text', orm['filer_cmsplugins.FilerImage:alt_text']),
            ('caption', orm['filer_cmsplugins.FilerImage:caption']),
            ('use_autoscale', orm['filer_cmsplugins.FilerImage:use_autoscale']),
            ('width', orm['filer_cmsplugins.FilerImage:width']),
            ('height', orm['filer_cmsplugins.FilerImage:height']),
            ('float', orm['filer_cmsplugins.FilerImage:float']),
            ('free_link', orm['filer_cmsplugins.FilerImage:free_link']),
            ('page_link', orm['filer_cmsplugins.FilerImage:page_link']),
            ('description', orm['filer_cmsplugins.FilerImage:description']),
        ))
        db.send_create_signal('filer_cmsplugins', ['FilerImage'])
        
        # Adding model 'FilerFile'
        db.create_table('cmsplugin_filerfile', (
            ('cmsplugin_ptr', orm['filer_cmsplugins.FilerFile:cmsplugin_ptr']),
            ('file', orm['filer_cmsplugins.FilerFile:file']),
            ('title', orm['filer_cmsplugins.FilerFile:title']),
        ))
        db.send_create_signal('filer_cmsplugins', ['FilerFile'])
        
        # Adding model 'FilerTeaser'
        db.create_table('cmsplugin_filerteaser', (
            ('cmsplugin_ptr', orm['filer_cmsplugins.FilerTeaser:cmsplugin_ptr']),
            ('title', orm['filer_cmsplugins.FilerTeaser:title']),
            ('image', orm['filer_cmsplugins.FilerTeaser:image']),
            ('use_autoscale', orm['filer_cmsplugins.FilerTeaser:use_autoscale']),
            ('width', orm['filer_cmsplugins.FilerTeaser:width']),
            ('height', orm['filer_cmsplugins.FilerTeaser:height']),
            ('free_link', orm['filer_cmsplugins.FilerTeaser:free_link']),
            ('page_link', orm['filer_cmsplugins.FilerTeaser:page_link']),
            ('description', orm['filer_cmsplugins.FilerTeaser:description']),
        ))
        db.send_create_signal('filer_cmsplugins', ['FilerTeaser'])
    ...
    complete_apps = ['filer_cmsplugins']

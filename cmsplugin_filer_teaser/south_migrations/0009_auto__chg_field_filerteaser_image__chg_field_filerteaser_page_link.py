...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FilerTeaser.image'
        db.alter_column(u'cmsplugin_filer_teaser_filerteaser', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.Image'], null=True, on_delete=models.SET_NULL))

        # Changing field 'FilerTeaser.page_link'
        db.alter_column(u'cmsplugin_filer_teaser_filerteaser', 'page_link_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Page'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'FilerTeaser.image'
        db.alter_column(u'cmsplugin_filer_teaser_filerteaser', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.Image'], null=True))

        # Changing field 'FilerTeaser.page_link'
        db.alter_column(u'cmsplugin_filer_teaser_filerteaser', 'page_link_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Page'], null=True))

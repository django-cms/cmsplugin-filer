...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FilerLinkPlugin.mailto'
        db.alter_column(u'cmsplugin_filer_link_filerlinkplugin', 'mailto', self.gf('django.db.models.fields.EmailField')(max_length=254, null=True))

    def backwards(self, orm):

        # Changing field 'FilerLinkPlugin.mailto'
        db.alter_column(u'cmsplugin_filer_link_filerlinkplugin', 'mailto', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table('cmsplugin_filerlinkplugin', 'cmsplugin_filer_link_filerlinkplugin')

    def backwards(self, orm):
        db.rename_table('cmsplugin_filer_link_filerlinkplugin', 'cmsplugin_filerlinkplugin')

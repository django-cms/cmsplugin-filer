...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FilerLinkPlugin.title'
        db.add_column(u'cmsplugin_filer_link_filerlinkplugin', 'title',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FilerLinkPlugin.title'
        db.delete_column(u'cmsplugin_filer_link_filerlinkplugin', 'title')

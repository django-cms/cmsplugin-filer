...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('cmsplugin_filerlinkplugin', 'file_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.File'], null=True, on_delete=models.SET_NULL))
    ...
    models = {
        ...
        'cmsplugin_filer_link.filerlinkplugin': {
            ...
            'file': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['filer.File']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
